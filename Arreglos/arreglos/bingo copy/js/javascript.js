 ...
 function numero(multiplicador,hasta){
  
 
    let array=[];
    for ( let desde;desde< hasta; desde++){
        let multiplicacion = multiplicador* desde;
    ...
    function crearBingo() {
        ...
        for (let fila = 0; fila < 5; fila++) {
            ...
            for (let columna = 0; columna < 5; columna++) {
                interno[columna] = numero(2, 10)[randomIndex];;
            }
            bingo[fila] = interno;
        }
        return bingo;
    ...
    colorearColumnas('tabla5', [0], 'green');
